    ...
    <div className="mb-4">
      ...
      <div className="md:hidden w-full bg-white border border-gray-200 rounded-lg p-3 shadow-sm">
         ...
         <div className="relative">
           ...
           <div className="pointer-events-none absolute left-0 top-0 bottom-0 w-40 rounded-l-lg bg-[#0B3D91] flex items-center justify-center">
             <span className="text-[12px] font-black tracking-wide text-white">TR</span>
           </div>
           <select
             className="w-full appearance-none bg-white border-2 border-gray-900/80 text-gray-900 text-base font-black text-center [text-align-last:center] rounded-lg focus:ring-primary-blue focus:border-primary-blue block py-2.5 pr-12 pl-44 shadow-sm"
             onChange={(e) => {
