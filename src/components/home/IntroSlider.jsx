      ...
      >
        ...
        <div className="relative h-full flex items-center justify-between px-4 md:px-6 gap-3">
          <div className="flex items-center gap-3 min-w-0">
            <span className="inline-flex items-center justify-center w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-white/15 border border-white/20 flex-shrink-0">
              <current.Icon className="w-7 h-7 md:w-8 md:h-8 text-white" />
            </span>
